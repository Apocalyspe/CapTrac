...
public class CaptracController {
	...
	/*
	 * @RequestMapping("/addexpense") public ModelAndView SaveExpense(ExpenseModel
	 * model, HttpSession session, CredentialManager creds) {
	 * 
	 ...
	 * return mv; }
	 * 
	 * @RequestMapping("/register") public ModelAndView Register(CredentialManager
	 * creds,HttpSession session) {
	 * 
	 * ModelAndView mv = logic.Register(creds,session);
	 * 
	 * return mv; }
	 * 
	 * @RequestMapping("/changepass") public ModelAndView
	 * ChangePassword(CredentialManager creds,HttpSession session) {
	 * 
	 ...
	 */
	  ...
	  public List<CredentialManager> getall(){
